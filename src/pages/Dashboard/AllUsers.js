...
const AllUsers = () => {
    const userUrl = `https://dry-earth-97304.herokuapp.com/allusers`;
    const {
        data: users,
        isLoading,
        refetch,
    ...
    const handleDlt = async (email) => {
        const url1 = `https://dry-earth-97304.herokuapp.com/allusers/dlt/${email}`;
        Swal.fire({
            title: "Are you sure?",
    ...
    const handleAdmin = async (user) => {
        ...
        const url1 = `https://dry-earth-97304.herokuapp.com/allusers/makeadmin/${email}`;
        Swal.fire({
            title: "Are you sure?",
