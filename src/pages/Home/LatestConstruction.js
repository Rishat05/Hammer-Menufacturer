            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-5'>
                <div class="card w-96 bg-base-100 shadow-xl">
                    <figure class="px-10 pt-10">
                        <img src={latest1} alt="Shoes" class="rounded-xl h-56" />
                    </figure>
                    <div class="card-body items-center text-center">
                        {/* <h2 class="card-title">hammer </h2> */}

                    </div>
                </div>
                <div class="card w-96 bg-base-100 shadow-xl">
                    <figure class="px-10 pt-10">
                        <img src={latest2} alt="Shoes" class="rounded-xl h-56" />
                    </figure>
                    <div class="card-body items-center text-center">
                ...
                <div class="card w-96 bg-base-100 shadow-xl">
                    <figure class="px-10 pt-10">
                        <img src={latest3} alt="Shoes" class="rounded-xl h-56" />
                    </figure>
                    <div class="card-body items-center text-center">
                        {/* <h2 class="card-title">Shoes!</h2> */}
